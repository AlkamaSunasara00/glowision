// FILE: src/app/components/WishlistPage.jsx
...
// ─── Build product URL from wishlist item ─────────────────────────────────────
// Wishlist items are saved with: { category, slug }
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        <p className="font-['DM_Sans'] text-[11px] font-semibold text-[var(--color-blue)] uppercase tracking-[0.8px] mb-1 capitalize">
...
export default function WishlistPage() {
  ...
  if (loading) return (
    <div className="min-h-screen flex items-center justify-center">
      <p className="font-['DM_Sans'] text-[var(--color-blue-dark)] font-semibold">Loading...</p>
    </div>
  );
    ...
    <>
      <style>{`
        ...
        @media (max-width: 580px) {
          .wl-item-grid { grid-template-columns: 90px 1fr !important; }
          .wl-item-grid .wl-thumb { width: 90px !important; height: 90px !important; }
          .wl-item-actions { flex-direction: row !important; grid-column: 1 / -1; justify-content: flex-end; padding-top: 12px; border-top: 1px solid var(--color-border); }
        }
      `}</style>
      ...
      <section className="bg-[var(--color-bg-main)] min-h-screen pt-6 pb-28">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          {/* Breadcrumb */}
          <nav className="flex items-center gap-1.5 text-[13px] mb-6 flex-wrap font-['DM_Sans'] pb-4 border-b border-[var(--color-border)]">
          ...
          {wishlist.length === 0 ? (
            <div className="bg-[var(--color-white)] rounded-3xl border border-[var(--color-border)] shadow-[var(--shadow-soft)] px-6 py-20 text-center">
              ...
              <Link href="/products">
                <button className="inline-flex items-center gap-2 px-9 py-3.5 rounded-full bg-[var(--color-blue-dark)] text-white font-['DM_Sans'] font-bold text-[14px] border-none cursor-pointer hover:-translate-y-0.5 transition-all duration-300">
